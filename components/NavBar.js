...
const Navbar = () => {
  ...
  return (
    <>
      {/* Sticky Navbar */}
      <nav className="bg-red-600 text-white z-50">
      ...
      {/* Non-Sticky Navbar */}
      <nav id='responsibelNonStickyNavbar' className="sticky z-10 top-0 bg-white border border-gray-300 py-4 text-black">
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            ...
            <div className="search-container justify-center">
              <div className="w-full max-w-md flex">
                <input
                  ...
                  placeholder="Search..."
                  id='resSearchBar'
                  className="w-full px-2 py-2 rounded-md bg-white text-gray-700 focus:outline-none border border-gray-300"
                />
          ...
          {/* Mobile Menu */}
          <div id='marginTop' className={`md:hidden flex flex-col space-y-8 transition-all duration-1000 justify-between items-center ${isOpen ? 'opacity-100 max-h-full' : 'opacity-0 max-h-0 overflow-hidden'}`}>
            <Link href="/" className="mt-10 text-gray-700 hover:text-red-600 no-underline">Home</Link>
            <Link href="/products" className="text-gray-700 hover:text-red-600 no-underline">Products</Link>
            <Link href="/#about" className="text-gray-700 hover:text-red-600 no-underline">About Us</Link>
